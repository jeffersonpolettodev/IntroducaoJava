public class ContaBanco {
    ...
    public void pagarMensal(){
        ...
        if (this.getStatus() == true){
            ...
            System.err.println("Impossível pagar mensalidade de uma conta fechada");
        }

    } // end metodo pagarMensal
